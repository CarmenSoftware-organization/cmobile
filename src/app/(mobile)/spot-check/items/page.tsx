...
function SpotCheckItemsPage() {
  ...
  const method = searchParams.get("method") || "random";
  ...
  const handleBack = () => {
    ...
    router.push(`/spot-check/method?${params.toString()}`);
  };
      ...
      <header className="p-4 border-b bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
          ...
          <div className="flex-1">
            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-blue-600 dark:text-blue-400 font-medium">Step 3: Items</span>
              </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 border border-blue-200 dark:border-blue-800">
          <div className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
            ...
            <div><strong>Method:</strong> {getMethodName()}</div>
          </div>
        </div>
      </header>
